...
internal partial class MainWindow : Window
{
    ...
    //  新增物理模拟变量 
    private double _velocity;// 表针当前的运动速度
    private readonly double _stiffness = 0.29; //刚度（弹簧拉力）：值越大响应越快，(范围 0.05 - 0.3)
    private readonly double _friction = 0.42;  // 阻尼（摩擦力）：值越大停下得越快。 (范围 0.1 - 0.5)
    ...
    private void OnAudioDataAvailable(object? sender, AudioDateEventArgs e)
    {
        ...
        // 将振幅转换为对数分贝 dBFS 
        // 声音在程序里的原本值是在 0.0 到 1.0 之间，用公式 20*log10(rms) 算出分贝数
